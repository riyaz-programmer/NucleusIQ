...
| [Text-to-SQL Eval Showcase](text_to_sql_eval/README.md) | Agent evaluation | Autonomous text-to-SQL agent, five eval patterns, pytest + scorecard. [Blog](https://www.nucleusbox.com/evaluating-text-to-sql-agents-with-nucleusiq/). |
